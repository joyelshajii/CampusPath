...
router.get('/', authenticate, (req, res) => res.json(db.all('SELECT * FROM Departments ORDER BY dept_name')));
...
router.post('/', authenticate, authorize('admin'), (req, res) => {
    ...
    try {
        const r = db.run('INSERT INTO Departments(dept_name,dept_code) VALUES(?,?)', [dept_name, dept_code]);
        db.persist();
